...
class Event(Base):
    ...
    source_url: Mapped[str | None] = mapped_column(Text)  # link de acesso a fonte (sempre)
    source_language: Mapped[str | None] = mapped_column(String(8))  # idioma original (resumo e pt-BR)
