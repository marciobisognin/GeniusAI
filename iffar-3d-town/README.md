...
Cada prédio (Reitoria e os 13 campi) mostra **todo o organograma daquela unidade física** — não apenas os cargos de topo — organizado por **repartição real**, lado a lado num único andar contínuo, no estilo dos organogramas oficiais em corte isométrico: cada Pró-Reitoria/Diretoria real vira um **bloco numerado (1, 2, 3...) com moldura colorida própria**, salas em tom neutro por dentro, para a cor de identidade morar na moldura do bloco, não no piso. O prédio inteiro é emoldurado por um **gramado com árvores** nas bordas, com um letreiro de título "Organograma — [Reitoria/Campus]" sempre visível. Cada agente é um **avatar recortado diretamente dos organogramas oficiais de referência** (busto visto de frente) — não desenhado do zero por código — sentado atrás de uma mesa de madeira com um único monitor; um pequeno elenco de pessoas se repete pelo prédio, mas nunca um código de função (nada de "CD-0001"/"FG-0002"): o que se vê é sempre a repartição e a pessoa de fato designada para ela, como no organograma oficial. O Gabinete ocupa a maior área, à esquerda, com mobília mais completa (quadros, sofá, estante); cada bloco numerado agrupa uma ou mais salinhas da mesma repartição — uma de 12 pessoas vira 3 salas de 4, lado a lado, nunca uma sala só apinhada de mesas coladas; repartições muito pequenas (um ou dois cargos, comum em conselhos e comissões) são agrupadas numa sala compartilhada de "Colegiados e Comissões", sem moldura numerada. Intercalados entre as áreas de trabalho, quatro **espaços de convivência** — Estar (sofás e mesa de centro), Copa (mesinhas de café), Reunião (mesa redonda grande) e Zen (almofadas em volta de uma fonte, para uma pausa de descompressão) — dão um ar mais humano e próximo do dia a dia real de uma instituição de ensino. No fim do corredor, um **pátio de entrada** com bancos, jardineiras e o letreiro "Bem-vindo(a)! IFFar — [nome do prédio]" fecha o andar, como o portão de acesso de um campus de verdade. Todos os avatares **respiram de leve** o tempo todo (defasados entre si) e os cursores piscam nas telas, então o andar nunca parece congelado.
