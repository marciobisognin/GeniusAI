...
> descreve o produto unificado que integra os cinco projetos deste repositório
> (SO-IA, Foresight, Civilizations, IFFar 3D Town e IFFar Pixel Art) com Hermes Agent, OmniRift e os conceitos
...
- **[`iffar-pixel-art/`](iffar-pixel-art/)** — centro operacional espacial do IFFar: recebe a demanda, deriva a rota da Portaria nº 876/2026-GRE, exige checkpoints humanos quando aplicável, despacha CLIs reais registradas e só libera arquivos cujo hash foi verificado. Veja o [README do projeto](iffar-pixel-art/README.md) e a [arquitetura](iffar-pixel-art/docs/architecture.md).
- **[`iffar-3d-town/`](iffar-3d-town/)** — gêmeo digital 3D isométrico da estrutura organizacional do IFFar, com interface React/Three.js, câmera dinâmica e bridge local para orquestrações do Nirvana OS. Veja o [README do projeto](iffar-3d-town/README.md).
