---
name: iffar-evidencia-rastreavel
description: Registrar evidências e handoffs rastreáveis no Instituto Federal Farroupilha, com base na Portaria Eletrônica nº 876/2026-GRE. Use quando a demanda envolver uma unidade que exerça esta competência.
license: MIT
---

# Registrar evidências e handoffs rastreáveis
...
Fundamento declarado nos manifestos: *Contrato de execução do IFFar Pixel Art*.
